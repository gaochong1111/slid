(theory Slrdi
 ...
 :sorts ((Field 2) (SetLoc 0) (SetRef 1) (Space 0) (Real 0)  (Int 0) (BagInt 0))
 ...
 "The SLRDI theory corresponds to signature of the SLRDI logic
  ...
  - for all sp in Space, v a location variable, sr in SetRef, 
   ...
   - for all i in Int, b1, b2 in BagInt:
      ...
      - (bagminus b1 b2) denotes bag difference b1 \ b2;

      - (cmp b1 b2) is true if all elements of b1 are in cmp relation 
        with all elements of b2;
