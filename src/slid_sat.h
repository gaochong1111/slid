...
//in_alloc_loc_arrays declare
NOLL_VECTOR_DECLARE(slid_in_alloc_loc_arrays, slid_in_alloc_loc_array *);
...
typedef struct{
	...
	slid_in_alloc_loc_arrays *m;     //matrix of bool variables
...
slid_in_alloc_loc_arrays *slid_mk_in_alloc_loc_arrays(Z3_context, Z3_sort, noll_var_array *,\
							noll_space_array *);
slid_in_alloc_loc_array *slid_mk_in_alloc_loc_array_pto(Z3_context, Z3_sort, noll_var_array *,\
							unsigned int, unsigned int);
slid_in_alloc_loc *slid_mk_in_alloc_loc(Z3_context, Z3_sort, noll_var_array *,\
					unsigned int, unsigned int);
void slid_get_in_alloc_loc_index(noll_uid_array *, noll_ls_t *);
slid_in_alloc_loc_array *slid_mk_in_alloc_loc_array_ls(Z3_context, Z3_sort, noll_var_array *,\
							noll_ls_t *, unsigned int);
slid_in_alloc_loc *slid_in_alloc_loc_locate(slid_in_alloc_loc_arrays *, unsigned int, unsigned int);
Z3_ast slid_in_alloc_loc_find(slid_in_alloc_loc_arrays *, unsigned int, unsigned int);
...
Z3_ast _slid_mk_pure_data_constr1(Z3_context, slid_context, noll_dterm_array *,\
					Z3_ast (*)(Z3_context, Z3_ast, Z3_ast));
Z3_ast _slid_mk_pure_data_constr2(Z3_context, slid_context, noll_dterm_array *,\
					Z3_ast (*)(Z3_context, unsigned int, Z3_ast const[]));
...
Z3_ast _slid_mk_pred_data_constr_stc(Z3_context, slid_context, noll_dform_t *, noll_ls_t *,\
					Z3_ast (*)(Z3_context, Z3_ast, Z3_ast));


Z3_ast slid_mk_pred_data_constr_trans(Z3_context, slid_context, slid_data_constr *, noll_ls_t *, int);
Z3_ast _slid_mk_pred_data_constr_trans(Z3_context, slid_context, slid_data_constr *, noll_dform_t *,\
					noll_ls_t *, int, Z3_ast (*)(Z3_context, Z3_ast, Z3_ast));

Z3_ast slid_mk_assist_constr(Z3_context, slid_context, noll_dterm_t *,\
				noll_dform_t *, noll_ls_t *, int);
Z3_ast _slid_mk_assist_constr(Z3_context, slid_context, noll_dterm_t *, noll_ls_t *,\
				Z3_ast, Z3_ast, Z3_ast (*)(Z3_context, Z3_ast, Z3_ast));
